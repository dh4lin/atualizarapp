...
button.luatools-header-button {
    ...
    height: 36px;
    padding: 0;
    border: 2px solid transparent; /* Remove a borda visível mantendo o tamanho físico */
    border-radius: 4px;
    background: transparent; /* Deixa o fundo 100% transparente */
    color: transparent; /* Esconde o ícone ou texto interno */
    cursor: pointer;
    transition: all 0.3s cubic-bezier(0.34, 1.56, 0.64, 1);
...
button.luatools-header-button:hover {
    background: ${theme.bgHover}; /* Cor de fundo surge no hover */
    color: ${theme.text}; /* Ícone interno surge no hover */
    transform: translateY(-1px);
    box-shadow: 0 4px 12px ${theme.shadowHover}; /* Sombra surge no hover */
    border-color: ${theme.borderHover}; /* Borda de hover surge */
}
...
button.luatools-header-button svg {
    height: 16px;
    width: 16px;
    opacity: 0; /* Garante que imagens ou SVGs internos sumam por padrão */
    transition: opacity 0.3s ease;
}

button.luatools-header-button:hover img,
button.luatools-header-button:hover svg {
    opacity: 1; /* Faz as imagens ou SVGs reaparecerem no hover */
            }
        `;
  }
  ...
  function showSettingsPopup() {
    ...
    ensureTranslationsLoaded(false)
      ...
      .finally(function () {
        ...
        titleText.textContent = t("menu.title", "Menu");
        ...
        removeBtn.innerHTML =
          ...
          t("menu.removeLuaTools", "Remove Patrocínio") +
          "</span>";
            ...
            try {
              Millennium.callServerMethod("luatools", "CheckForUpdatesNow", {
                ...
                try {
                  ...
                  ShowLuaToolsAlert("Patrocínio", msg);
                } catch (_) { }
              });
            } catch (_) { }
          });
        ...
        if (discordBtn) {
          discordBtn.addEventListener("click", function (e) {
            ...
            const url = "https://discord.com/invite/y2PCxwPnmU";
            try {
            ...
            try {
              Millennium.callServerMethod("luatools", "FetchFreeApisNow", {
                ...
                try {
                  ...
                  ShowLuaToolsAlert("Patrocínio", text);
                } catch (_) { }
              });
            } catch (_) { }
          });
          ...
          fixesMenuBtn.addEventListener("click", function (e) {
            ...
            try {
              ...
              if (isNaN(appid)) {
                ...
                ShowLuaToolsAlert("Patrocínio", errText);
                return;
              }
              ...
              Millennium.callServerMethod("luatools", "GetGameInstallPath", {
                ...
                .catch(function () {
                  ...
                  ShowLuaToolsAlert("Patrocínio", errorText);
                });
            } catch (err) {
                      ...
                      Millennium.callServerMethod(
                        ...
                        .then(function () {
                          try {
                            ...
                            ShowLuaToolsAlert("Patrocínio", successText);
                          } catch (err) {
                            backendLog(
                        ...
                        .catch(function (err) {
                          ...
                          ShowLuaToolsAlert("Patrocínio", errMsg);
                        });
                    } catch (err) {
        ...
        Millennium.callServerMethod("luatools", "UnFixGame", {
          ...
          .then(function (res) {
            ...
            if (payload && payload.success) {
              ...
              ShowLuaToolsAlert("Patrocínio", errorMsg);
            }
          })
          .catch(function () {
  ...
  function showSettingsManagerPopup(forceRefresh, onBack) {
    ...
    title.textContent = t("settings.title", "Patrocínio · Settings");
  ...
  function showLuaToolsAlert(title, message, onClose) {
    ...
    titleEl.textContent = String(title || "Patrocínio");
  ...
  function updateButtonTranslations() {
    try {
      ...
      if (luatoolsBtn) {
        const addViaText = lt("Solicitar Patrocínio");
                ...
                fetchFixes(appid).then(function (fixesData) {
                  ...
                  if (btn) {
                    ...
                    if (span && span.textContent === "Unplayable") {
                      span.textContent = lt("Solicitar Patrocínio");
                    }
                  }
        ...
        Millennium.callServerMethod("luatools", "GetAddViaLuaToolsStatus", {
          ...
          try {
            ...
            if (st.status === "checking" && st.currentApi && title) {
              title.textContent = lt("Patrocínio · {api}").replace(
                "{api}",
                st.currentApi,
              );
            } else if (
              ...
              title.textContent = t("common.appName", "Patrocínio");
            }
            ...
            if (["checking content", "done"].includes(st.status)) {
              ...
              if (title) title.textContent = t("common.appName", "Patrocínio");
  ...
  function showLoadedAppsPopup(apps) {
    ...
    title.textContent = lt("Patrocínio · Jogos adicionados");
    const body = document.createElement("div");
